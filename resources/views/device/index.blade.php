...
@section('content-header')
    <h1>{{__('device.device')}}</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{__('device.device')}}</a></li>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <a href="{{ route('device.index') }}" class="btn btn-info btn-sm">
                ...
                <div class="box-body">
                    ...
                    <form id="formSearch" method="POST" class="form-horizontal">
                        <div class="form-group">
                            <label for="macAddress" class="control-label col-lg-2">{{__('device.macAddress')}}</label>
                            <div class="col-lg-4">
                                <input class="form-control" name="macAddress" id="macAddress">
                            </div>

                            <label for="lastVaccinDate" class="control-label col-lg-2">{{__('device.lastVaccinDate')}}</label>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="description" class="control-label col-lg-2">{{__('device.description')}}</label>
                            <div class="col-lg-4">
                ...
                <div class="box-body">
                    ...
                    <div class="table-responsive hide-quick-search">
                        <table id="dataTable" class="table table-bordered table-striped w-100">
                            ...
                            <tr>
                                <th>{{__('commons.sl')}}</th>
                                <th>{{__('device.macAddress')}}</th>
                                <th>{{__('device.lastVaccinDate')}}</th>
                                <th>{{__('device.description')}}</th>
    ...
    <script>
        $(function () {
            ...
            let dataTable = $('#dataTable').DataTable({
                ...
                initComplete: function () {
                    ...
                    $('#btnExportXLSX').on('click',function () {
                        location.href = '{{ route('device.exportXLSX') }}' + dataTableUrl;
                    });
                }
            });

            let getUrlQueries = function() {
                let deviceName = $('#macAddress').val();
                let deviceCode = $('#lastVaccinDate').val();
            ...
            let ajaxRequest = function () {
                ...
                dataTable.ajax.url('{{ route('device.index') }}' + dataTableUrl);
                dataTable.draw();
            };
