        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                <form method="POST"
                    ...
                    @if (App\Helpers\CommonHelper::isCapable('medicines.printDetails'))
                        <a href="{{ route('medicines.printDetails', $medicine->id) }}" class="btn btn-sm btn-warning"
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-show">
                    ...
                    <tr>
                        ...
                        <td>{{ optional($medicine->cattle)->title }}</td>
                    </tr>
                    <tr>
